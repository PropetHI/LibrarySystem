...
public class LibrarySystem {
    ...
    public void addBookWithTitleAndAuthorlist(String title, String authors) throws Exception {
    ...
    public static void main(String[] args) throws Exception, NullUserException, NullBookException, UserCannotBorrowSameBookException {
        ...
        librarySystem.addBookWithTitleAndAuthorlist("The Hobbit", "J.R.R. Tolkien");
        librarySystem.users.add(new User("John"));
